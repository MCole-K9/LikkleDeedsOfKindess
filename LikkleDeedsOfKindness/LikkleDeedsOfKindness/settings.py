"""
Django settings for LikkleDeedsOfKindness project.
...
SECRET_KEY = 'django-insecure-d&qjtxb)^5#()ktonh!en#s+0m-9o-0wawx$%noe&ao60p1csn'
...
ROOT_URLCONF = 'LikkleDeedsOfKindness.urls'
...
WSGI_APPLICATION = 'LikkleDeedsOfKindness.wsgi.application'
